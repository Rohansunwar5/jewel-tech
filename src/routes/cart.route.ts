...
import { addToCart, clearCart, generateEnquiry, getCart, removeFromCart, updateCartQuantity } from '../controllers/cart.controller';
...
cartRouter.post('/update', isLoggedIn, isApprovedDealer, asyncHandler(updateCartQuantity));
